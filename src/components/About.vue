<template>
    <section class="bg-primaryColor pt-14 pb-[120px] relative before:absolute before:bottom-[-25%] before:sm:bottom-0 before:right-0 before:w-[100px] before:h-[200px] before:bg-aboutIcon7">
