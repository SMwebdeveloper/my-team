<template>
    <section v-motion :initial="{opacity:0, y:-100}" :visibleOnce="{opacity:1, y:0, transition:{ duration:500}}" class="bg-primaryColor pt-20 pb-36 relative z-10 before:absolute before:bottom-0 before:right-0 before:w-[100px] before:h-[100px] before:md:h-[200px] before:bg-aboutIconMini7 before:md:bg-aboutIcon7  before:bg-no-repeat ">
