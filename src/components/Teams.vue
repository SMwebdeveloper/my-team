      ...
      >
        ...
        >
          <img
            ...
            alt="user image"
            class="w-[96px] h-[96px] rounded-full border-2 border-white mb-4 mx-auto"
          />
          <h4 class="text-[18px] font-bold text-raptureBlue leading-7">
            Nikita Marks
          </h4>
          <h6 class="tex-[15px] font-medium leading-6 text-white italic">
            Founder & CEO
          </h6>
          <span
        ...
        >
          ...
          <p
            class="text-[15px] text-white font-semibold leading-6 w-[254px] mx-auto mb-6"
          >
          ...
          <div class="flex items-center justify-center gap-x-2">
            <a href="#">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                class="w-7 text-white duration-200 hover:text-primaryLight"
              >
                <path
