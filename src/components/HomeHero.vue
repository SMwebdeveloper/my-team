<template>
  ...
  >
    ...
    >
        <h2 v-motion :initial="{opcity:0, y:100}" :visibleOnce="{opacity:1, y:0}" :duration="500" class="max-w-[635px] header-title mb-5 md:mb-6 lg:mb-0">
          Find the <br />
          best <span class="text-primaryLight">talent</span>
        </h2>
      <div
        class="max-w-[445px] lg:h-[195px] lg:flex lg:flex-col items-start justify-between animate-fade-up animate-once animate-duration-[600ms] animate-delay-300 animate-ease-in-out animate-normal animate-fill-both"
      >
